...
var pagetitle = new String("Eighteenth Birthday ");
...
var supporttemplate = new String("youare18.htm").toString();
var idtemplate = new String("newidcardfor18yearold.htm").toString();
...
objCDOMail.Subject=new String("Your Eighteenth Birthday").toString();
...
if (!(e.number &0xFFFF) == 0) {
	...
	Response.Write("Description:          "+e.description+"<br />");
		...
		kount += 1;
		Response.Write("&nbsp;&nbsp;&nbsp;18th birthday congratulations sent to "+memberObj.forename1+" "+memberObj.surname+"<br />")
	}
...
{
// ========================================================================
	// Secondly, send note to Membership Secretary for a new id/key card
	//=========================================================================
	...
	objCDOMail.From=new String("secretary@hamptontennis.org.uk");
	objCDOMail.Subject=new String("Eighteenth Birthday for Member").toString();
	// objCDOMail.BodyFormat=0;
	// objCDOMail.MailFormat=0;
	// objCDOMail.Body=new String(tMessage).toString();
	objCDOMail.HTMLBody=new String(sMessage).toString();
