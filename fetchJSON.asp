...
If queryref > -1 Then
	...
	querylist(2) = "SELECT Tdateofevent, eventdate, eventtime, eventtype, eventnote, eventreport, enddate, endtime FROM futureevents WHERE eventdate > Date() AND eventdate < (Date()+20) ORDER BY eventdate ASC;"
