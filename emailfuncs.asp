...
function processPersonalMergeFields(message,personid)
{
	...
	sMessage = replaceAll(sMessage, "ZZchallengermixedZZ",oMember.challengermixeddoubles);
	sMessage = replaceAll(sMessage, "ZZmixedpartnerZZ",oMember.mixedpartner);
	sMessage = replaceAll(sMessage, "ZZchallengermixedpartnerZZ",oMember.challengermixedpartner);
	sMessage = replaceAll(sMessage, "ZZmixedplateZZ",oMember.mixedplate);
	sMessage = replaceAll(sMessage, "ZZvets40ZZ",oMember.vets40plus);
	sMessage = replaceAll(sMessage, "ZZvets45ZZ",oMember.vets45plus);
	sMessage = replaceAll(sMessage, "ZZvets40partnerZZ",oMember.vets40pluspartner);
	sMessage = replaceAll(sMessage, "ZZvets45partnerZZ",oMember.vets45pluspartner);
	...
	sMessage = replaceAll(sMessage, "ZZjuniorfinalsZZ",oMember.juniorfinalsday);
