...
Dim callbackfunc   'Name of the callback function to use in JSONP formulation 
Dim callbackstring 'String housing the JSONP return
...
' Establish the callback function name
' Default to processData
