...
var pagetitle = new String("Deleting a Log of a Quick Message");
...
SQLStmt = new String("delete from quickmessages where messageid = "+theid);
RstObj = ConnObj.Execute(SQLStmt);
if (! current_debug_status())
	Response.Redirect("qmess_list.asp")
