...
%>
<!--#include virtual="/Libs/VBScriptOAuth/oauth/_inc/hex_sha1_base64.asp"-->
<!--#include virtual="/Libs/VBScriptOAuth/oauth/cLibOAuth.Utils.asp"-->
<!--#include virtual="/Libs/VbsJson/VbsJson.asp"-->
<!--#include virtual="/Libs/AXEJSONParser/AXEJSONParser.asp"-->