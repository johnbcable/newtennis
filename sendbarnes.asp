...
var pagetitle = new String("Sending Pre-Prepared Email Circulars");
...
<!--   3. Content    -->
	<div id="content">
			...
			<form name="CircularForm" method="GET" action="barnestest.asp">
				<fieldset>
					<legend>Email Details</legend>
						...
						<div>
							...
							<input type="text" name="attach3" id="attach3" size=size="40" maxlength="90" >
						</div>
						<div>
...
%>
						...
						<div>
							<label for="debug">Are we debugging?:</label>
							<input type="text" name="debug" id="debug" size="1" value="N" tabindex="6">
						</div>
					</fieldset>
