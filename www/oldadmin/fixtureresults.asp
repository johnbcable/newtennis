					...
					<TABLE BORDER=1 COLS=" 10%,10%,10%,10%,10%,10%" WIDTH=80% ALIGN=CENTER CELLPADDING=5 bgcolor="#ffffff">
						<tr>
							<td class="tdfont" colspan="2" align="center">
								...
								result, click on submit and you will be taken to the appropriate list of
								fixtures available for you to choose which one to result.
								<br>
								<br>
							</td>
						</tr>
						...
						<TR>
							...
							<td class="tdfont" VALIGN=TOP bgcolor="#c0c0c0">
								<select name="theteam">
									<option>FRIENDLY
									<option>Ladies 1st Team
									<option>Ladies 2nd Team
									<option>Ladies 3rd Team
									<option>Mens 1st Team
									<option>Mens 2nd Team
									<option>Mens 3rd Team
									<option>All
								</select>
							</TD>
						</TR>
