...
<div id="content">
	<div id="mainContent">
		<h3>Junior Art &amp; Photography Competition</h3>
		<p>
			Enter our fun competition (below)
		</p>
		<div class="centered" id="jartcomp2008image" style="height: 830px;">
			<img src="http://www.hamptontennis.org.uk/images/jartcomp2008.jpg" width="562" height="814" border="0" alt="Junior Art &amp; Photography Competition 2008 promo" />
			<p class="caption" style="text-align:center;">Spice up your autumn term by trying to win some prizes in our great art and photography competition!</p>
		</div>	
	</div>
		<div id="rightcolumn">
