...
<!--   3. Content    -->
	<div id="content">
		...
		<div id="fistdivid">
			<h2>Coaching</h2>
			<img src="images/sizingguide.jpg" alt="Sizing guide chart for club sportswear" width="601" height="291" />
			<p>
				...
				overall standard. You cna check out <a href="adult_coaching.asp">current adult coaching</a> provision 
