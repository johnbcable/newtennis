...
var pagetitle = new String("Annual Tournaments in 2019");
...
<!--   3. Content    -->
	<div id="content">
		<h1>Playing:&nbsp;<b>Tournaments - 2019</b></h1>
<!--
...
-->
		...
		<p>
			The draws for the second half of this year&apos;s tournaments will be shown initially on the ClubSpark web site as they become available. Any updates will be posted there as and when they occur.
		</p>
		...
		<div class="seealso" style="clear: both;">
			<h3>See Also:</h3>
			<ul>
				<li><a href="finalsdays2019.asp">Finals day roundups</a></li>
				<li><a href="tours.asp?season=2019">Finals day results</a></li>
