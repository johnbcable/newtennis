...
<!--
 		<div class="promobox" style="clear: both; padding: 20px; margin-bottom: 20px; background-color: #fff; border: 2px solid black; ">
			<div>
				<h3>IMPORTANT: Saturday Junior Social Tennis Restarting</h3>
				<p>
					Junior social sessions will resume as usual from this Saturday 28<sup>th</sup> February.
				</p>
			</div>
...
%>
		<div id="covleague" class="bordertop" style="clear:both; position:relative;">
			...
			<div style="position: relative; float: right; margin-left: 10px;">
				...
				<img id="covleagueimage" src="images/covleague.gif" style="width: 100%; margin-right:20px;">
				</a>
			</div>
		</div>		
<%
...
<!--   1.  Branding   -->
<div id="branding">
	<a href="fullindex.html" id="homelink"><img id="clublogo" src="images/HamptonBadge.gif" alt="Hampton-In-Arden Sports Club logo" /></a>
	<h1>Hampton-In-Arden Sports Club</h1>
	<h2>Tennis Section</h2>
