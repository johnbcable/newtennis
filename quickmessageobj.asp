...
//  QuickMessageObject
//
//  Holds detail for a single quick message 
//

function QuickMessageObject(lessonid,day,start,finish,group) {
...
QuickMessageObject.prototype.setLessonText = function(lessontext) {
	this.lesson_text = lessontext;
};

QuickMessageObject.prototype.setDisplayOrder = function() {
