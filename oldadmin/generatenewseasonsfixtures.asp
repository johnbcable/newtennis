...
var pagetitle = new String("Generating new seasons fixtures ...");
var debugging = false;
var kount;
	...
	<div id="content"> 
		<div id="mainContent">
			...
			<div id="fixtureloadsummary">
				<p>
<%
SQL1 = new String("SELECT * from MensCoventryLeagueTeams ORDER BY teamname").toString();
RS = ConnObj.Execute(SQL1);
while (!RS.EOF)
{
	theteam = new String(RS("teamid")).toString();
...
SQL1 = new String("SELECT * from LadiesCoventryLeagueTeams ORDER BY teamname").toString();
RS = ConnObj.Execute(SQL1);
while (!RS.EOF)
{
	theteam = new String(RS("teamid")).toString();
