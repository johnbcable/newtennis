...
Response.Write("Dont know where to redirect to after this yet.");
Response.Write("Landed at preferences saving page.");
// Response.Redirect("./tests/mypreferences.html")
Response.End();
