...
var pagetitle = new String("Annual Tournament 2011");
...
<!--   3. Content    -->
	<div id="content">
		<h1>Playing:&nbsp;<b>Tournament Draw - 2011</b></h1>
<!--
...
-->
		<p>
			Below are the rules and the initial draw for the 2011 annual adult tournament. 
		...
		<div class="borderboth">
			...
			<ol type="disc">
				...
				<li>
					...
					social tennis.  Court 4 (not 1,2 or 3) may be booked during Sunday morning social tennis.  			
					</p>
				</li>
				<li>
					<p>
		...
		<div id="2010draw" class="centered">
			<img src="images/msgldraw2011.gif" alt="Mens singles draw for the 2011 tournament">
			<br />
			<img src="images/lsgldraw2011.gif" alt="Ladies singles draw for the 2011 tournament">
			<br />
			<img src="images/mdbldraw2011.gif" alt="Mens doubles draw for the 2011 tournament">
			<br />
			<img src="images/ldbldraw2011.gif" alt="Ladies doubles draw for the 2011 tournament">
			<br />
			<img src="images/mixddraw2011.gif" alt="Mixed doubles draw for the 2011 tournament">
			<br />
			<img src="images/mixpdraw2011.gif" alt="Mixed doubles plate draw for the 2011 tournament">
			<br />
			<img src="images/mvddraw2011.gif" alt="Veteran mens doubles draw for the 2011 tournament">
			<br />
			<img src="images/lvddraw2011.gif" alt="Veteran ladies doubles draw for the 2011 tournament">
			<br />
			<img src="images/mpltdraw2011.gif" alt="Mens singles plate draw for the 2011 tournament">
			<br />
			<img src="images/lpltdraw2011.gif" alt="Ladies singles plate draw for the 2011 tournament">
			<br />
			<img src="images/mvddraw2011over55.gif" alt="Veteran mens over-55 Challenge Wayman draw for the 2011 tournament">
			<br />
		</div>		
