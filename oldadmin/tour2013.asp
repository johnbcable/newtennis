...
var pagetitle = new String("Annual Tournament 2013");
...
<!--   3. Content    -->
	<div id="content">
		<h1>Playing:&nbsp;<b>Tournament Draw - 2013</b></h1>
<!--
...
-->
		<p>
			Below are the rules for the 2013 annual adult tournament. 
			Please make sure you all arrange and play your matches promptly.
		</p>
		<p>
			The draw will be posted here when it is made.
		</p>
		...
		<div class="seealso" style="clear: both;">
			<h3>See Also:</h3>
			<ul>
				<li><a href="finalsday2013.asp">Finals day report</a></li>
				<li><a href="tours.asp?season=2013">Finals day results</a></li>
				<li><a href="juniors/results.html?season=2013">Junior tournament results</a></li>
	<!--				
