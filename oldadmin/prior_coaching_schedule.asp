...
var pagetitle = new String("Junior Coaching Schedule - Summer 2013");
...
<!--   3. Content    -->
	<div id="content">
		<h1>Junior Coaching:&nbsp;<b>Summer 2013</b></h1>
		<p class="notprint">
			<strong>
		...
		<p>
			The courses start on <span style="font-weight: bold;">Monday 15<sup>th</sup> April</span> and run 
			for <span style="font-weight: bold;">13 weeks</span> (excluding half term, <span style="font-weight: bold;">week 
			beginning 27<sup>th</sup> May</span>). 
		</p>
		<p class="notprint">
		...
		<table id="coachingscheduletable">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<ul>
							...
							<li>Tue 1630 - 1715 (Mini Tennis Red 2)</li>
							<li>Wed 1545 - 1630 (Mini Tennis Red 1/2/3) - 2 classes</li>
				...
				<tr>
					...
					<td>
						<ul class="leftindent">
							<li>Mon 1700 - 1800 - Performance (with Full Ball)</li>
							<li>Wed 1545 - 1630 (Mini Tennis Orange/Green - age 8-10)</li>
							<li>Wed 1630 - 1715 (Mini Tennis Green / Full Ball)</li>
							<li>Thu 1545 - 1630 (Mini Tennis Green - age 10)</li>
							<li>Fri 1715 - 1800 (Mini Tennis Orange/Green - age 8-10)</li>
						</ul>
					</td>
				</tr>
				...
				<tr>
					<td width="50%">
						<span class="blueheading">Under 14</span><br /><br />
						<p class="leftindent">
							Full court and normal yellow tennis balls, technical and tactical appropriate to the needs of the group.
						</p>
					</td>
			...
			<tfoot>
				<tr>
					<td colspan="2">
						...
						<p class="notprint">
						You may also view the <a href="https://hamptontennis.org.uk/prior_juniors/coaching_schedule.html">previous coaching schedule</a> (covering Spring term 2013 up to  
						start of Easter state school holidays).
						</p>
