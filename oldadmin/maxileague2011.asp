...
var pagetitle = new String("Maxi-Tennis League - Spring 2011");
	...
	<div id="content">
		...
		<table>
			...
			<tbody>
				<tr>
					<td>
						<!--#include file="maxi2011league.htm" -->
					</td>
				</tr>
			</tbody>
			<tfoot>
		...
		<div class="seealso">
			<h3>See Also:</h3>
			<ul>
				<li><a href="maxifinals2011.asp">Finals Day - results and roundup</a></li>
