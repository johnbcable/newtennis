...
var pagetitle = new String("Tournament Finals Days - 2014");
...
<!--   3. Content    -->
	<div id="content">
		...
		<h1>Tournament:&nbsp;<b>Finals Days 2014</b></h1>
		...
		<p class="leader">
			 In 2014, we had two finals days. The first was on Saturday 28<sup>th</sup> June which covered the Under 18 and Under 14 junior singles titles, the Box league play-offs and the Challenger Tournament finals. The second took place on Saturday September 27<sup>th</sup> and this covered the Mini-Tennis titles and the remainder of the adult tournament categories.
		</p>
		...
		<div id="main2014orderofplay">
			<p>
				The scheduled order of play and the summary results for the 27<sup>th</sup> September 2014 finals is shown below. Names highlighted in yellow are the winners for that match.
			</p>
...
<!-- 		<p class="team">
 ...
 -->
		...
		<div class="seealso" style="clear: both; margin-top: 10px; border-top: 1px solid black;">
			<h2>See Also:</h2>
			<ul>
				<li><a href="tours.asp?season=2014">2014 Summary results</a></li>
				...
				<li><a href="juniors/results.html?season=2014">Junior tournament results for 2014</a></li>
			</ul>
		</div>	
