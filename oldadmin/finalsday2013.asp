...
var pagetitle = new String("Tournament Finals Day - 2013");
...
<!--   3. Content    -->
	<div id="content">
		<h1>Tournament:&nbsp;<b>Finals Day 2013</b></h1>

		<div id="finalsday2012collage" class="collage">
			 <img alt="Finals Day 2013" src="Images/finalsday2012_collage.jpg" width="700" height="200">
		</div>
		<p class="leader">
			 &nbsp;
		</p>
		...
		<div id="finalsday2013orderofplay">
			<p>
				The scheduled order of play for the 2013 finals is shown below. 
			</p>
			 <img alt="Finals Day 2013 Order of Play" src="Images/orderofplay2013.jpg" width="601" />
			 <p style="clear: both;">
			 	Please note:
			 	<ol type="number">
			 		<li>Players should arrive in good time for play to commence promptly (1/2 hour early)</li>
			 		<li>Trophy presentations to take place at approx 6pm, provided all matches have completed</li>
			 		<li>After the start of the first matches, subsequent timings are approximate</li>
			 		<li>On the court-side scoreboard, first named player/pair is the &quot;Home&quot; team.
			 	</ol>
			 </p>
		</div>
		<p class="matchreport" style="clear: both; padding-top: 10px; margin-top: 10px; border-top: 1px solid black;">
			Apologies for the abbreviated armchair text below (any alternate contributions very welcome) but unfortunately I had to play this year instead of putting my feet up and watching everyone else run around like mad things. [JC]
		</p>
		<p class="team">
		...
		<p class="matchreport" style="padding-top: 10px; margin-top: 10px; border-top: 1px solid black;">
			Saturday morning's weather was fair and sunny, gradually clouding over during the afternoon 
			but staying dry. A great crowd turned out to watch proceedings, even into the twilight of the final matches. The tea/coffee/cakes were all great and much appreciated (although I think it is 
			quite tenuous to claim that a slice of banana cake constituted one of my 5 a day (Jo)!).
		</p>
		<p class="matchreport">
			Many thanks to all the players, volunteers and spectators for turning out and making this yet another great finals day. See you all next year!
		</p>
		<div class="seealso" style="clear: both; margin-top: 10px; border-top: 1px solid black;">
			<h2>See Also:</h2>
			<ul>
				<li><a href="tours.asp?season=2013">2013 Summary results</a></li>
<!--
				<li><a href="thumbnails.asp?gallery=11">Photo gallery</a></li>
-->
				<li><a href="tour2013.asp">The route to the 2013 finals</a></li>
				<li><a href="juniors/results.html?season=2013">Junior tournament results for 2013</a></li>
			</ul>
		</div>	
