...
var pagetitle = new String("Annual Tournaments in 2014");
...
<!--   3. Content    -->
	<div id="content">
		<h1>Playing:&nbsp;<b>Tournaments - 2014</b></h1>
<!--
...
-->
		<p>
			Below are the rules for the 2014 annual tournaments. This year there will be two finals days - 28th June and 27th September.  
			Please make sure you all arrange and play your matches promptly to allow the draw to progress.
		</p>
		<h2>Tournament Draw</h2>
		<p>
			The draws for the September half of this year&apos;s tournaments are shown below. Any updates will be posted here as and when they occur.
		</p>

		<ul type="none">
			<li><a href="TourDraws2014.pdf">All tournament draws &raquo;</a></li>
		</ul>
...
-->
		<div class="seealso" style="clear: both;">
			<h3>See Also:</h3>
			<ul>
				<li><a href="finalsdays2014.asp">Finals day roundups</a></li>
				<li><a href="tours.asp?season=2014">Finals day results</a></li>
				<li><a href="juniors/results.html?season=2014">Junior tournament results</a></li>			
