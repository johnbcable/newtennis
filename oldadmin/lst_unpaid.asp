...
var pagetitle = new String("Unpaid Fees");
...
SQLStmt = new String("SELECT * FROM members WHERE paid NOT LIKE 'Y'  AND membergrade IN ('Adult','18-25s','Junior') ORDER BY surname, membergrade, forename1");
...
<!--   3. Content    -->
	<div id="content">
		<h1>Members:&nbsp;<b>people with unpaid fees</h1>
<%
if (debugging)
{
...
%>
		<form name="paidform" id="paidform" action="upd_paid.asp" action="GET">
			<p>
				DO NOT check more than 20 at a time or the update of the club database will fail.
			</p>
<!--
		<div style="float: right; text-align: right; margin-right: 5px; width: 50%; display: inline-block;">
			 <input type="button" name="CheckAll" value="Check All"
			 	onClick="checkAll(document.paidform.paidbox)">
			 <input type="button" name="UnCheckAll" value="Uncheck All"
			 onClick="uncheckAll(document.paidform.paidbox)">
		</div>
-->		
		<table style="clear:both;" id="memberlist">
			<caption>&nbsp;</caption>
			<thead>
<%
...
%>
		...
		<tfoot>
			<tr>
				<td colspan="3">
					<p class="centered">
						<%= memberknt %> members currently marked as having unpaid fees
						<br />
<%
if (memberknt>0)
{
%>
						Check the Paid? box to indicate that this member has now paid their fees.<br /><br />
						DO NOT check more than 20 at a time or the update of the club database will fail.
<%
...
-->
		...
		<div class="seealso">
			<h2>See Also:</h2>
			<ul>
				<li><a href="/lst_paid.asp">Members who have paid their subs</a></li>
			</ul>
		</div>			
