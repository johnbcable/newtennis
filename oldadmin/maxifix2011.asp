		...
		<tr>
			...
			<td>
				...
				<table align=left width=567 border="1" cellspacing="2" cellpadding="5">
					<tr>
						<td class="tdfont" >
							<font face="Verdana" size="2">Once again, spring 2011 sees the 
							running of the Maxi-Tennis internal team competition. The main aim of
...
%>
                            ...
                            would like you to play. The 2011 fixture list is 
				...
				<table align=left border=1 cellspacing=3 cols=2 width=567>
					<tr>
						<td class=tdfont align=center colspan=2>
                            ...
                            <a href="maxiresults2011.asp">here </a>.
							<br>
						    <br>
                            Good luck to everyone in this tournament in 2011!
						    </font>
						    </td>
					</tr>
				</table>
