...
var pagetitle = new String("Fifth Birthday ");
...
var supporttemplate = new String("youare5.htm").toString();
var coachtemplate = new String("coaching5yearold.htm").toString();
...
objCDOMail.Subject=new String("Your Fifth Birthday").toString();
...
// ========================================================================
	...
	objCDOMail.From=new String("secretary@hamptontennis.org.uk");
	objCDOMail.Subject=new String("Fifth Birthday for Member").toString();
	// objCDOMail.BodyFormat=0;
	// objCDOMail.MailFormat=0;
	// objCDOMail.Body=new String(tMessage).toString();
	objCDOMail.HTMLBody=new String(sMessage).toString();
