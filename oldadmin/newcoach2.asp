...
<div id="content">
	...
	<div id="coachimage">
		<img class="floatleft" src="images/tn_david1.jpg" width="150" height="222" ALT="David Mountford joins the coaching team at Hampton" />
		<p class="caption"></p>
	</div>
	<p>
		<h5>
	...
	<p>
		Ian's interim coaching schedule can be found <a href="juniors/coaching_schedule.html">here</a>. We will publish further details from
		Ian of his coaching schedule soon.
	</p>
	</div>
		<div id="rightcolumn">
