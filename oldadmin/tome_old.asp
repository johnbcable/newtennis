...
<table  width="100%" border="0" cellspacing="2" cellpadding="5" cols="100,*,120">
  <tr>
    <td>
    	<br>Sending email to me for testing<br><br>
...
Server.ScriptTimeout = 360;
	...
	// end of attachments
	objNewMail.To=new String("jcable@dial.pipex.com");
	if (debugging == "Y")
	{
		Response.Write("Recipient would be [jcable@dial.pipex.com]<br>");
	}
	else
	{		
		Response.Write("Recipient is [jcable@dial.pipex.com]<br>");
		objNewMail.Send();
	}
	objNewMail=null;
%>
