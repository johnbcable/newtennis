...
var pagetitle = new String("Hampton-In-Arden Tennis Club - Boules");
...
<!--   3. Content    -->
	<div id="content">
		...
		<p>
			...
			The club now has two outdoor boules piste areas for use in these competitions. 
		</p>
		<p>
			It is a lovely way to spend an hour or 
			two on the weekend or a weekday evening. Anyone interested in playing boules should contact the current secretary of the 
			league - contact details are available in the clubhouse - for details of how to take part.
		</p>
	</div>
