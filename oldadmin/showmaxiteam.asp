...
//
if (!signedin())
	Response.Redirect("showmaxiteamsummary.asp?maxiteam="+themaxiteam);
...
SQL3 = new String("SELECT * from allmembers where maxiteam = '"+themaxiteam+"' and membergrade not in ('Ex-Member','Non-Member','Social') order by surname, forename1").toString();
//
...
<!--   3. Content    -->
	<div id="content">
		...
		<div id="contactnote" style="background-color:yellow; color:#000000; clear:both;">
			<p class="centered">
				<br />
				N.B.  You can see contact details for <%= m_teamname %> members below because you have signed-in to the members area<br />
				Contact details are NOT available to you if you do not sign-in to the members area with the username/password you have been allocated
				<br />
			</p>
		</div>
		<p>
			<table id="maxitenniscaptaindetails">
				<caption>Current Captains - <%= theCurrentYear %> Season</caption>
				<thead>
					<tr>
						<th>Name</th>
...
while (! RS2.EOF)
{
	...
	Response.Write("                	<tr>");
	Response.Write("						<td><strong>"+m_captain+"</strong></td>");
	Response.Write("						<td>");
	Response.Write(m_fulladdress);
	Response.Write("							Telephone:  "+m_phone+"<br />");
	Response.Write("							Email:      "+mEmail+"<br />");
	Response.Write("						</td>");
	Response.Write("					</tr>");
...
%>
		...
		<div id="maxiteammemberlist">
			<table id="maxiteamlist">
				<caption>Club Members Currently in <%= themaxiteam %> </caption>
				<thead>
					<tr>
						<th>Name</th>
						<th>Contact Details</th>
						<th style="text-align: center;">Player<br />Pool</th>
					</tr>
				</thead>
				<tbody>
<%
...
while (! RS3.EOF)
{
	...
	Response.Write("                	<tr>");
	Response.Write("						<td><strong>"+mName+"</strong></td>");
	Response.Write("						<td>");
	Response.Write(m_fulladdress);
	Response.Write("							Telephone:  "+m_phone+"<br />");
	Response.Write("							Email:      "+mEmail+"<br />");
...
%>
		...
		<p>
			Click on another team flag (below) to check out another team profile
		</p>
